...
#         ./multicrab -c status -d <work area> (to check job status)
    ...
    config.Data.inputDataset    = '/ZToEE_NNPDF31_13TeV-powheg_M_50_120/RunIIFall17MiniAODv2-PU2017_12Apr2018_94X_mc2017_realistic_v14-v1/MINIAODSIM'
    #config.Data.inputDataset   = '/ZToEE_NNPDF31_13TeV-powheg_M_50_120/RunIIFall17DRPremix-94X_mc2017_realistic_v10-v2/MINIAODSIM'
